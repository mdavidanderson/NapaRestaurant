...
namespace RestaurantWebSite.Controllers
{
    ...
    public class MenuManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,Price,ItemImgUrl,ItemCategory,ItemDescription")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,Price,ItemImgUrl,ItemCategory,ItemDescription")] Item item)
        {
            if (ModelState.IsValid)
            {
